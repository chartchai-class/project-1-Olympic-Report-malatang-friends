    ...
    <form class=" shadow-lg max-w-md mx-auto hover:scale-105 transform transition duration-500 ease-in-out">   
        ...
        <div class="relative">
            ...
            <div class="border-1 border-blue-500">            
                <button type="submit" class="text-[#1A3A63] flex  outline-blue-700 absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
